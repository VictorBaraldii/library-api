...
import io.github.victorbaraldii.libraryapi.controller.mappers.AutorMapper;
import io.github.victorbaraldii.libraryapi.model.Autor;
import io.github.victorbaraldii.libraryapi.security.SecurityService;
import io.github.victorbaraldii.libraryapi.service.AutorService;
...
@Operation(summary = "Obter Detalhes", description = "Retorna os dados do autor pelo ID.")
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "484", description = "Autor não encontrado.")
    })
